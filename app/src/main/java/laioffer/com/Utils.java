...
public class Utils {
    ...
    public static int distanceBetweenTwoLocations(double currentLatitude, double currentLongitude, double destLatitude, double desLongitude) {
        Location currentLocation = new Location("CurrentLocation");
        currentLocation.setLatitude(currentLatitude);
        currentLocation.setLongitude(currentLongitude);
        Location desLocation = new Location("DesLocation");
        desLocation.setLatitude(destLatitude);
        desLocation.setLongitude(desLongitude);
        double distance = currentLocation.distanceTo(desLocation);

        double inches = (39.370038 * distance);
